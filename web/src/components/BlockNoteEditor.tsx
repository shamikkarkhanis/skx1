          ...
          <SuggestionMenuController
            ...
            getItems={async (query): Promise<DefaultReactSuggestionItem[]> => {
              ...
              const custom: DefaultReactSuggestionItem[] = [
                ...
                { title: "alpha α", subtext: "Greek letter alpha", aliases: ["alpha","a"], group: "Greek", onItemClick: () => editor.insertInlineContent("α ") },
                { title: "beta β", subtext: "Greek letter beta", aliases: ["beta","b"], group: "Greek", onItemClick: () => editor.insertInlineContent("β ") },
                { title: "gamma γ", subtext: "Greek letter gamma", aliases: ["gamma","g"], group: "Greek", onItemClick: () => editor.insertInlineContent("γ ") },
                { title: "delta δ", subtext: "Greek letter delta", aliases: ["delta","d"], group: "Greek", onItemClick: () => editor.insertInlineContent("δ ") },
                { title: "epsilon ε", subtext: "Greek letter epsilon", aliases: ["epsilon","eps"], group: "Greek", onItemClick: () => editor.insertInlineContent("ε ") },
                { title: "zeta ζ", subtext: "Greek letter zeta", aliases: ["zeta","z"], group: "Greek", onItemClick: () => editor.insertInlineContent("ζ ") },
                { title: "eta η", subtext: "Greek letter eta", aliases: ["eta","h"], group: "Greek", onItemClick: () => editor.insertInlineContent("η ") },
                { title: "theta θ", subtext: "Greek letter theta", aliases: ["theta","th"], group: "Greek", onItemClick: () => editor.insertInlineContent("θ ") },
                { title: "iota ι", subtext: "Greek letter iota", aliases: ["iota","i"], group: "Greek", onItemClick: () => editor.insertInlineContent("ι ") },
                { title: "kappa κ", subtext: "Greek letter kappa", aliases: ["kappa","k"], group: "Greek", onItemClick: () => editor.insertInlineContent("κ ") },
                { title: "lambda λ", subtext: "Greek letter lambda", aliases: ["lambda","lam"], group: "Greek", onItemClick: () => editor.insertInlineContent("λ ") },
                { title: "mu μ", subtext: "Greek letter mu", aliases: ["mu","m"], group: "Greek", onItemClick: () => editor.insertInlineContent("μ ") },
                { title: "nu ν", subtext: "Greek letter nu", aliases: ["nu","n"], group: "Greek", onItemClick: () => editor.insertInlineContent("ν ") },
                { title: "xi ξ", subtext: "Greek letter xi", aliases: ["xi","x"], group: "Greek", onItemClick: () => editor.insertInlineContent("ξ ") },
                { title: "omicron ο", subtext: "Greek letter omicron", aliases: ["omicron","o"], group: "Greek", onItemClick: () => editor.insertInlineContent("ο ") },
                { title: "pi π", subtext: "Greek letter pi", aliases: ["pi","p"], group: "Greek", onItemClick: () => editor.insertInlineContent("π ") },
                { title: "rho ρ", subtext: "Greek letter rho", aliases: ["rho","r"], group: "Greek", onItemClick: () => editor.insertInlineContent("ρ ") },
                { title: "sigma σ", subtext: "Greek letter sigma", aliases: ["sigma","s"], group: "Greek", onItemClick: () => editor.insertInlineContent("σ ") },
                { title: "tau τ", subtext: "Greek letter tau", aliases: ["tau","t"], group: "Greek", onItemClick: () => editor.insertInlineContent("τ ") },
                { title: "upsilon υ", subtext: "Greek letter upsilon", aliases: ["upsilon","u","y"], group: "Greek", onItemClick: () => editor.insertInlineContent("υ ") },
                { title: "phi φ", subtext: "Greek letter phi", aliases: ["phi","ph"], group: "Greek", onItemClick: () => editor.insertInlineContent("φ ") },
                { title: "chi χ", subtext: "Greek letter chi", aliases: ["chi","ch"], group: "Greek", onItemClick: () => editor.insertInlineContent("χ ") },
                { title: "psi ψ", subtext: "Greek letter psi", aliases: ["psi","ps"], group: "Greek", onItemClick: () => editor.insertInlineContent("ψ ") },
                { title: "omega ω", subtext: "Greek letter omega", aliases: ["omega","om"], group: "Greek", onItemClick: () => editor.insertInlineContent("ω ") },

                // Greek letters (uppercase)
                { title: "Gamma Γ", subtext: "Greek letter Gamma", aliases: ["Gamma"], group: "Greek", onItemClick: () => editor.insertInlineContent("Γ ") },
                { title: "Delta Δ", subtext: "Greek letter Delta", aliases: ["Delta"], group: "Greek", onItemClick: () => editor.insertInlineContent("Δ ") },
                { title: "Theta Θ", subtext: "Greek letter Theta", aliases: ["Theta"], group: "Greek", onItemClick: () => editor.insertInlineContent("Θ ") },
                { title: "Lambda Λ", subtext: "Greek letter Lambda", aliases: ["Lambda"], group: "Greek", onItemClick: () => editor.insertInlineContent("Λ ") },
                { title: "Xi Ξ", subtext: "Greek letter Xi", aliases: ["Xi"], group: "Greek", onItemClick: () => editor.insertInlineContent("Ξ ") },
                { title: "Pi Π", subtext: "Greek letter Pi", aliases: ["Pi"], group: "Greek", onItemClick: () => editor.insertInlineContent("Π ") },
                { title: "Sigma Σ", subtext: "Greek letter Sigma", aliases: ["Sigma"], group: "Greek", onItemClick: () => editor.insertInlineContent("Σ ") },
                { title: "Upsilon Υ", subtext: "Greek letter Upsilon", aliases: ["Upsilon"], group: "Greek", onItemClick: () => editor.insertInlineContent("Υ ") },
                { title: "Phi Φ", subtext: "Greek letter Phi", aliases: ["Phi"], group: "Greek", onItemClick: () => editor.insertInlineContent("Φ ") },
                { title: "Psi Ψ", subtext: "Greek letter Psi", aliases: ["Psi"], group: "Greek", onItemClick: () => editor.insertInlineContent("Ψ ") },
                { title: "Omega Ω", subtext: "Greek letter Omega", aliases: ["Omega"], group: "Greek", onItemClick: () => editor.insertInlineContent("Ω ") },
              ];
